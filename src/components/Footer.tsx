    ...
    <footer className="bg-gradient-to-b from-gray-950 to-black text-gray-400">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-gray-500">
              Dedicated to fostering civic consciousness and defense
              preparedness among Filipino youth at the University of Nueva
              Caceres.
            </p>
          </div>
            ...
            <ul className="mt-5 space-y-4">
              <li className="flex items-start gap-3 text-sm">
                ...
                <span>
                  ...
                  <br />
                  Jaime Hernandez Avenue, Naga City, Camarines Sur, Philippines
                </span>
              </li>
            ...
            <div className="mt-8 flex gap-3">
              {[
                ...
                <a
                  ...
                  className="rounded-lg bg-gray-800 p-2.5 text-gray-500 transition-all duration-200 hover:bg-red-600 hover:text-white hover:shadow-lg hover:shadow-red-600/25"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center text-xs text-gray-600">
          &copy; {new Date().getFullYear()} University of Nueva Caceres — NSTP
